                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="position-relative">
                                                        <input name="kode" autocomplete="off" readonly
                                                            value="{{ kodeBarangInventaris() }}" type="text"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="position-relative">
                                                        <textarea class="form-control" autocomplete="off" name="keterangan" rows="5"></textarea>
                                                    </div>
                                                </div>
                                            </div>
