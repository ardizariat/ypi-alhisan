                ...
                <td>
                    <div class="btn-group">
                        <a href="{{ route('admin.rapat-yayasan.share', $item->id) }}" target="_blank"
                            ...
                            data-bs-original-title="bagikan" class="btn btn-sm btn-outline-info">
                            <i class="bi bi-share"></i>
                        </a>
                        <button data-bs-toggle="tooltip" title="ubah" data-bs-placement="top"
                            data-bs-original-title="ubah" class="btn btn-sm btn-outline-success">
                        ...
                        <button onclick="hapus(`{{ route('admin.rapat-yayasan.delete', $item->id) }}`)"
                            ...
                            data-bs-original-title="Hapus" class="btn btn-sm btn-outline-danger">
